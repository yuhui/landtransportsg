...
FACILITIES_MAINTENANCE_API_ENDPOINT = f'{
    BASE_API_ENDPOINT
}/FacilitiesMaintenance'
PASSENGER_VOLUME_BY_BUS_STOPS_API_ENDPOINT = f'{BASE_API_ENDPOINT}/PV/Bus'
PASSENGER_VOLUME_BY_ORIGIN_DESTINATION_BUS_STOPS_API_ENDPOINT = f'{
    BASE_API_ENDPOINT
}/PV/ODBus'
PASSENGER_VOLUME_BY_ORIGIN_DESTINATION_TRAIN_STATIONS_API_ENDPOINT = f'{
    BASE_API_ENDPOINT
}/PV/ODTrain'
PASSENGER_VOLUME_BY_TRAIN_STATIONS_API_ENDPOINT = f'{
    BASE_API_ENDPOINT
}/PV/Train'
PLATFORM_CROWD_DENSITY_REAL_TIME_API_ENDPOINT = f'{
    BASE_API_ENDPOINT
}/PCDRealTime'
PLATFORM_CROWD_DENSITY_FORECASE_API_ENDPOINT = f'{
    BASE_API_ENDPOINT
}/PCDForecast'
