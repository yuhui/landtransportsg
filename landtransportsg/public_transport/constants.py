...
FACILITIES_MAINTENANCE_API_ENDPOINT = \
    f'{BASE_API_ENDPOINT}/v2/FacilitiesMaintenance'
...
PASSENGER_VOLUME_BY_ORIGIN_DESTINATION_BUS_STOPS_API_ENDPOINT = \
    f'{BASE_API_ENDPOINT}/PV/ODBus'
PASSENGER_VOLUME_BY_ORIGIN_DESTINATION_TRAIN_STATIONS_API_ENDPOINT = \
    f'{BASE_API_ENDPOINT}/PV/ODTrain'
PASSENGER_VOLUME_BY_TRAIN_STATIONS_API_ENDPOINT = \
    f'{BASE_API_ENDPOINT}/PV/Train'
PLANNED_BUS_ROUTES_API_ENDPOINT = f'{BASE_API_ENDPOINT}/PlannedBusRoutes'
STATION_CROWD_DENSITY_REAL_TIME_API_ENDPOINT = \
    f'{BASE_API_ENDPOINT}/PCDRealTime'
STATION_CROWD_DENSITY_FORECAST_API_ENDPOINT = \
    f'{BASE_API_ENDPOINT}/PCDForecast'
...
FACILITIES_MAINTENANCE_ARGS_KEY_MAP = {
...
PLANNED_BUS_ROUTES_SANITISE_IGNORE_KEYS = BUS_ROUTES_SANITISE_IGNORE_KEYS
