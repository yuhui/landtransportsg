...
CARPARK_AVAILABILITY_API_ENDPOINT = f'{BASE_API_ENDPOINT}/CarParkAvailabilityv2'
...
FLOOD_ALERTS_API_ENDPOINT = f'{BASE_API_ENDPOINT}/PubFloodAlerts'
...
TRAFFIC_SPEED_BANDS_API_ENDPOINT = f'{BASE_API_ENDPOINT}/v4/TrafficSpeedBands'
